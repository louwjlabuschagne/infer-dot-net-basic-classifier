...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1912.403 at 13:21 on Wednesday, 27 January 2021.
	/// </remarks>
		...
		private void Changed_featureValue_isSetosa_numberOfIterations(int numberOfIterations)
		{
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int n = 0; n<100; n++) {
					...
					noisyScore_F[n] = GaussianFromMeanAndVarianceOp.SampleAverageConditional(score_F[n], 10.0);
					...
					score_B[n] = GaussianFromMeanAndVarianceOp.MeanAverageConditional(noisyScore_use_B[n], 10.0);
